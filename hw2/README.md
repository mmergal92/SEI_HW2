...
We will need to branch for this assignment (after we folk and clone the repo like before):

Create a branch called "hw2": `git checkout -b hw2`

Make changes per usual and then add and commit those!

Then when you push, there may be a message about making sure to create the branch in your remote ("online") repo.
...
- Submit your homework via Github pull request with title `First_Name Last_Name - Assignment_Name` *AND* branch name `hw2` before the start of next class.
- Need a reminder on how to submit homework? Take a look at the [guide](https://git.generalassemb.ly/sei-flex-302/homework/tree/master/hw1#important-git-commands-cheatsheet)
